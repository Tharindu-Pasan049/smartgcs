...
import 'package:smartgcs/pages/vendor/vendor_home.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  void _loginUser(MainModel model, UserType userType, String route) {
    model.login(_formData['email'], _formData['password'],_auth, userType).then((data) {
      if (data['success']) {
        // if(userType==UserType.Client){
        // Navigator.pushAndRemoveUntil(context, MaterialPageRoute(
        //         builder: (BuildContext context) =>  HomePage(data['userid'])
        //       ), (Route route) => false);
        //       }

        //  else{
        // Navigator.pushAndRemoveUntil(context, MaterialPageRoute(
        //         builder: (BuildContext context) =>  VendorHomePage(data['userid'])
        //       ), (Route route) => false);
        //  }     
                        ...
                        builder: (BuildContext context, Widget child,
                          ...
                          return model.isLoading ///////////////////////////
                           ...
                           //return  RaisedButton(
                             ...
                             //child: Text('Login'),
                             //onPressed: (){
                             // Navigator.pushReplacementNamed(context, widget.userType == UserType.Client ? 'home' : 'vendor_home');
                           //  },
                         //  );
                        },
                      ),
