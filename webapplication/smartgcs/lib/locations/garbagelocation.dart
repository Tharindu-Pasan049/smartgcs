...
class LocationGarbage extends StatefulWidget {
  LocationGarbage(this._userID,{Key key}) : super(key: key);
  final String _userID;
  @override
  _MapDriverState createState() => _MapDriverState();
}

class _MapDriverState extends State<LocationGarbage> {
...
bool mapToggle=true;
 ...
 title: Container(
          ...
          alignment: Alignment.topLeft,
          child: Text("Garbage Bin\'s Location",
           ...
           //   if (snapshot.hasData) {
            ...
            if (snapshot.data.data()!=null) {
             ...
             // GeoPoint position = LatLng(snapshot.data.data()['location']['latitude'],snapshot.data.data()['location']['longitude']);
              ...
              String binno=snapshot.data.data()['number_of_bins'];
              String wastetype=snapshot.data.data()['waste_type'];
              String datecreated=snapshot.data.data()['Date_of_created'];
                  ...
                  Positioned.fill(
                    child: GoogleMap(
                      ...
                      markers: {
                        ...
                        content: Text("waste_type:  "+wastetype+"   |   "+"no_of_bins:  "+binno+"  |  "+"Bin_Created_Date:  "+datecreated),
                        ...
                        // ),
                          ...
                          // onInfoWindowTap: () {
                          //   title:Text("garbage");
                          //  // InformationCollector("TEST","TEST"),
                          // },
