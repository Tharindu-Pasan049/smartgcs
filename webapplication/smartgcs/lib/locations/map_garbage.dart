...
class MapGarbage extends StatefulWidget {
  MapGarbage(this._userID) : super();
  final _userID;
  @override
  _MapGarbageState createState() => _MapGarbageState();
}

class _MapGarbageState extends State<MapGarbage> {
  @override
  void initState() {
    super.initState();
